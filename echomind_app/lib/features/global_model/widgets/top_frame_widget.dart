...
class TopFrameWidget extends StatelessWidget {
  ...
  static const _routes = [AppRoutes.globalKnowledge, null, AppRoutes.globalExam];
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: i == 1 ? AppTheme.primary : AppTheme.surface,
                      borderRadius: BorderRadius.circular(16),
                    ),
                    child: Text(
                      _tabs[i],
                      style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: i == 1 ? Colors.white : AppTheme.textSecondary),
                    ),
                  ),
                ),
              ],
