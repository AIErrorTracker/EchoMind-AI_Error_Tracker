            ...
            Row(
              ...
              children: [
                const Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('目标分数', style: TextStyle(fontSize: 13, color: AppTheme.textSecondary)),
                    SizedBox(height: 4),
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.baseline,
                      textBaseline: TextBaseline.alphabetic,
                      children: [
                        Text('70', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w800)),
                        SizedBox(width: 4),
                        Text('分 (物理)', style: TextStyle(fontSize: 13, color: AppTheme.textSecondary)),
                      ],
                    ),
                  ],
                ),
