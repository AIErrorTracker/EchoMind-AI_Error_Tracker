...
class TrainingDialogueWidget extends StatelessWidget {
  ...
  static Widget _completedStepCard({required String step, required String summary}) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(children: [
            Text(step, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: AppTheme.primary)),
            ...
            Container(
              ...
              child: const Text('已通过', style: TextStyle(fontSize: 10, color: AppTheme.primary, fontWeight: FontWeight.w600)),
            ),
          ]),
          const SizedBox(height: 4),
          Text(summary, style: const TextStyle(fontSize: 13, color: AppTheme.textSecondary)),
        ],
      ),
    );
  }
