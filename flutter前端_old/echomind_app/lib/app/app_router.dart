...
import 'package:echomind_app/features/community/community_detail_page.dart';
...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: AppRoutes.knowledgeDetail, builder: (_, __) => const KnowledgeDetailPage()),
    GoRoute(path: AppRoutes.knowledgeLearning, builder: (_, __) => const KnowledgeLearningPage()),
    GoRoute(path: AppRoutes.modelDetail, builder: (_, __) => const ModelDetailPage()),
    ...
    GoRoute(path: AppRoutes.questionDetail, builder: (_, __) => const QuestionDetailPage()),
    ...
    GoRoute(path: AppRoutes.communityDetail, builder: (_, __) => const CommunityDetailPage()),
  ],
);
